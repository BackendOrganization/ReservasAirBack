...
describe('flightsController', () => {
  ...
  describe('ingestFlight', () => {
    test('debería reservar un vuelo exitosamente y retornar 201', () => {
  ...
  test('debería retornar 400 ya que los datos están incompletos', () => {
  ...
  test('debería retornar error 500 por error en el modelo', () => {
      const mockFlightData = {
        id: 'AR123',
        origin: 'BUE',
        destination: 'MIA',
